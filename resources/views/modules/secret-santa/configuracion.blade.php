...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- Seccion de controles del juego -->
            <div class="christmas-card">
    ...
    <script>
        ...
        function updateToggleGameButton() {
            ...
            if (!toggleGameBtn || !toggleGameText) {
                return; // Los elementos no existen aun
            }
        ...
        // Funcion para iniciar/detener el juego
        ...
        // Funcion para bloquear/desbloquear inputs
        ...
        // Funcion para habilitar vista a todos los jugadores
        ...
        function addPlayerToTable(player) {
            ...
            // Si la tabla esta vacia, eliminar el mensaje de "no hay jugadores"
            if (tbody.querySelector('td[colspan]')) {
                tbody.innerHTML = '';
            }

            // Contar filas existentes para el numero
                ...
                if (data.success) {
                    ...
                    if (row) {
                        ...
                        setTimeout(() => {
                            ...
                            // Si no hay mas jugadores, mostrar mensaje
                            if (rows.length === 0) {
                                const tbody = document.getElementById('playersTableBody');
                                tbody.innerHTML = `
                                    <tr>
        ...
        // Funcion de confirmacion para generar URLs
        ...
        // Funcion para generar URLs con IDs de jugadores mezclados aleatoriamente
        async function generateUrlsWithPlayerIds() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // Recargar la pagina para actualizar las tablas
                    setTimeout(() => {
        ...
        // Funcion de confirmacion para eliminar todos los jugadores
        ...
        // Funcion para eliminar todos los jugadores
        ...
        // Funcion para restablecer la vista de una URL
        ...
        // Funcion para actualizar el estado visual del boton de inputs
