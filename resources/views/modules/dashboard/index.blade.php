...
@section('title', 'Dashboard - SecretFriend')
...
<style>
    ...
    .module-btn.primary { background: #6366f1; color: white; }
    .module-btn.primary:hover { background: #4f46e5; }
    .module-btn.secondary { background: #f1f5f9; color: #475569; }
    .module-btn.secondary:hover { background: #e2e8f0; }
    ...
    async function runFundraisingManual() {
        ...
        try {
            ...
            if (data.success) {
                ...
                alert('Error: ' + (data.message || 'No se pudo ejecutar'));
            }
        } catch (error) {
            console.error('Error:', error);
            ...
            btn.disabled = false;
            btn.textContent = 'Ejecutar cobro manual';
        }
    }
